<div class="modal-dialog" role="document">
	{!! Form::open(['url' => route('purchase.update_shipping', [$transaction->id]), 'method' => 'put', 'id' => 'edit_shipping_form' ]) !!}
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">@lang('lang_v1.edit_shipping') - {{$transaction->ref_no}}</h4>
