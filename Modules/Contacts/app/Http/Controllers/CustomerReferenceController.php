...
use Modules\Contacts\Models\CustomerReference; // Need to create this model too
...
class CustomerReferenceController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $customer_reference = Datatables::of($query)
                ->addColumn(
                    ...
                    <li><a data-href="{{action(\'\Modules\Contacts\Http\Controllers\CustomerReferenceController@edit\', [$id])}}" class="btn-modal edit_reference_button" data-container=".customer_reference_modal"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</a></li>
                    @endcan
                    <li><a href="{{action(\'\Modules\Contacts\Http\Controllers\CustomerReferenceController@destroy\', [$id])}}" class="delete_reference_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</a></li>
        ...
        return view('contacts::customer_reference.index');
    }
    ...
    public function create()
    {
        ...
        $vehicals = [];
        return view('contacts::customer_reference.create')->with(compact('contacts', 'help_explanations', 'quick_add', 'vehicals'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('contacts::customer_reference.edit')->with(compact('contacts', 'help_explanations', 'customer_reference'));
    }
