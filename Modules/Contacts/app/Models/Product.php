...
class Product extends TenantModel
{
    ...
    {
        return $this->hasMany(\Modules\Contacts\Models\ProductVariation::class); // Assuming this might move too or stay in App
    }
    ...
    {
        return $this->belongsTo(\App\Models\Unit::class, 'secondary_unit_id');
    }
    ...
    {
        return $this->belongsToMany(\Modules\Contacts\Models\Product::class, 'res_product_modifier_sets', 'modifier_set_id', 'product_id');
    }
    ...
    {
        return $this->belongsToMany(\Modules\Contacts\Models\Product::class, 'res_product_modifier_sets', 'product_id', 'modifier_set_id');
    }
