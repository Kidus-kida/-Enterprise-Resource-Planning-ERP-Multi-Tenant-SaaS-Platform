        ...
        <div class="row">
           ...
           <div class="col-md-6">
                <div class="input-block mb-3">
                    ...
                    <x-form.input type="number" name="amount" step="0.01" required />
                </div>
           </div>
           <div class="col-md-6">
                 <div class="input-block mb-3">
                    <x-form.label>{{ __('Paid On') }} <span class="text-danger">*</span></x-form.label>
                    <x-form.input type="date" name="paid_on" value="{{ date('Y-m-d') }}" required />
                </div>
           </div>
            ...
            <div class="col-md-6">
                 <div class="input-block mb-3">
                    <x-form.label>{{ __('Ref No') }}</x-form.label>
                     <x-form.input type="text" name="payment_ref_no" />
                </div>
           </div>
