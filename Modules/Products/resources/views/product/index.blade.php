    ...
    <div class="content container-fluid">
        ...
        <x-breadcrumb class="col">
            ...
            <x-slot name="right">
                <div class="col-auto float-end ms-auto">
                    @can('product.create')
                        <a href="{{action([\Modules\Products\Http\Controllers\ProductController::class, 'create'])}}"
                            class="btn add-btn">
                    ...
                    @if($is_admin)
                        <a class="btn btn-success"
                            href="{{action([\Modules\Products\Http\Controllers\ProductController::class, 'downloadExcel'])}}">
        ...
        <div class="card mb-3">
            <div class="card-header" style="cursor: pointer;" data-bs-toggle="collapse"
                data-bs-target="#product_filter_collapse" aria-expanded="false" aria-controls="product_filter_collapse">
                <h5 class="card-title mb-0">
                    <i class="fa fa-filter"></i> Filters
                    <i class="fa fa-chevron-down float-end toggle-icon"></i>
                </h5>
            </div>
            <div class="collapse" id="product_filter_collapse">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="form-label" for="product_list_filter_type">Product Type:</label>
                                <select class="form-control select2" style="width:100%" id="product_list_filter_type"
                                    name="type">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2 category_id" style="width:100%"
                                    id="product_list_filter_category_id" name="category_id">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2 sub_category_id" style="width:100%"
                                    id="product_list_filter_sub_category_id" name="sub_category_id">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2 semi_finished" style="width:100%"
                                    id="product_list_filter_semi_finished" name="semi_finished">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2 product_id" style="width:100%"
                                    id="product_list_filter_product_id" name="product_id">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" style="width:100%" id="product_list_filter_unit_id"
                                    name="unit_id">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" style="width:100%" id="product_list_filter_tax_id"
                                    name="tax_id">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" style="width:100%" id="product_list_filter_brand_id"
                                    name="brand_id">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-control select2" style="width:100%" id="active_state"
                                    name="active_state">
                                    <option value="">All</option>
                        ...
                        <div class="col-md-3">
                            <div class="form-check mt-4">
                                <input type="checkbox" name="not_for_selling" value="1"
                                    class="form-check-input input-icheck" id="not_for_selling">
                                <label class="form-check-label" for="not_for_selling"><strong>Not For
                                        Selling</strong></label>
                            </div>
                        </div>
                        @if($is_woocommerce)
                            <div class="col-md-3">
                                <div class="form-check mt-4">
                                    <input type="checkbox" name="woocommerce_enabled" value="1"
                                        class="form-check-input input-icheck" id="woocommerce_enabled">
