...
$(document).ready(function () {
    ...
    $(document).on('input', 'input#single_dpp', function (e) {
        ...
        var selling_tax_rate = $('select#sale_tax').find(':selected').data('rate') ?? 0;
        ...
        if (tax_type == 'inclusive') {
            var selling_price_inc_tax = __add_percent(selling_price, selling_tax_rate);
    ...
    $(document).on('input', 'input#single_dpp_inc_tax', function (e) {
        ...
        __write_number($('input#single_dsp_inc_tax'),selling_price_inc_tax.toFixed(2));
    ...
    $(document).on('input', 'input#single_dsp_inc_tax', function (e) {
        ...
        var tax_type = $('#tax_type').val();
        if (tax_type == 'inclusive') {
            var selling_price = __get_principle(selling_price_inc_tax, selling_tax_rate);
        } else if (tax_type == 'exclusive') {
    ...
    // Only initialize fileinput if the plugin is available
    if ($('#upload_image').length > 0 && typeof $.fn.fileinput !== 'undefined') {
        $('#upload_image').fileinput(img_fileinput_setting);
    }

    // Only initialize CKEDITOR if it's available
    if ($('textarea#product_description').length > 0 && typeof CKEDITOR !== 'undefined') {
