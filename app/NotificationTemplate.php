    ...
    public static function customerNotifications()
    {
        ...
        return [
            ...
            'customer_loan_given' => [
                ...
                'extra_tags' => ['{loan_date}, {business_name}', '{business_logo}', '{contact_name}', '{loan_amount}', '{outstanding_amount}']
            ],
            'cheque_return' => [
                'name' => __('lang_v1.cheque_return'),
                'extra_tags' => ['{customer_name}, {total_amount}', '{bank_name}', '{transaction_date}']
            ],
        ];
    }
