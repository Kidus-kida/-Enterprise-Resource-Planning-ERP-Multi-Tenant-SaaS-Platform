...
class Category extends \App\Models\TenantModel
{
    ...
    public static function forDeviceDropdown($business_id)
    {
        $categories_query = Category::where('business_id', $business_id)
            ->where('parent_id', 0)->where('category_type', 'device');
    ...
    public static function forDeviceDropdownAuto($business_id)
    {
        $categories_query = Category::where('business_id', $business_id)
            ->where('parent_id', 0)->where('category_type', 'auto-device');
