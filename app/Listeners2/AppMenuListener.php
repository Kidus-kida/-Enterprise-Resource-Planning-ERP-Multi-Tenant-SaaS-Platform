...
class AppMenuListener
{
    ...
    public function handle(AppMenuEvent $event): void
    {
        ...
        // if(auth()->user()->can(['view-employees','view-departments','view-designations','view-holidays'])){
        if(true){
            ...
            $menu
                ->submenu(
                    ...
                    Menu::new()
                        ...
                        ->add(Link::toRoute('attendances.index', __('Attendance'))->addClass(route_is(['attendances.index']) ? 'active' : ''))
