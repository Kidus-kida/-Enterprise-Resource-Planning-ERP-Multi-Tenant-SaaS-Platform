...
@section('page-content')
    <div class="content container-fluid">
        ...
        <div class="modal fade" role="dialog" aria-labelledby="gridSystemModalLabel" id="account_groups_modal">
        </div>
    </div>
    <!-- /.content -->
    ...
    <script>
        $(document).ready(function () {
            ...
            other_account_table = $('#other_account_table').DataTable({
                ...
                'serverSide': false,
                'ajax': {
                    url: '/deposits-module/deposits?account_type=other',
                    data: function (d) {
            ...
            $('#other_account_table tbody').on('click', '.plus_singh', function () {
                ...
                if ($("#table_" + id).length == 0) {
                    $.ajax({
                        method: "POST",
                        url: "/deposits-module/account_details",
                        data: { id: id },
                        dataType: 'json',
                        success: function (result) {
            ...
            function loadNamesOtion() {
                postData = {
                    "account_type_s": $('#account_type').val(),
        ...
        function get_cheques_list() {
            if ($('#transaction_date_range_cheque_deposit').val()) {
                ...
                $.ajax({
                    method: 'get',
                    url: '{{route("deposits.getChequeList")}}',
        ...
        function get_realize_cheques_list() {
            ...
            if ($('#realize_cheque_date').val()) {
                ...
                $.ajax({
                    method: 'get',
                    url: '{{route("deposits.getRealizeChequeList")}}',
