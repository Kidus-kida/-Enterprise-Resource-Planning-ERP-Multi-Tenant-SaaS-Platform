    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Edit Invoice Layout</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a
                                href="{{ action([\App\Http\Controllers\InvoiceSchemeController::class, 'index']) }}">Invoice
                                Settings</a></li>
                        <li class="breadcrumb-item active">Edit Layout</li>
                    </ul>
                </div>
            </div>
        </div>

        <form action="{{ action([\App\Http\Controllers\InvoiceLayoutController::class, 'update'], [$invoice_layout->id]) }}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="design" class="form-control select" required>
                                            @foreach ($designs as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $invoice_layout->design == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="header_text" class="form-control" rows="3">{{ $invoice_layout->header_text }}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check form-switch mt-3">
                                        <input class="form-check-input" type="checkbox" name="show_business_name"
                                            value="1" id="show_business_name"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check form-switch mt-3">
                                        <input class="form-check-input" type="checkbox" name="show_location_name"
                                            value="1" id="show_location_name"
                                            {{ $invoice_layout->show_location_name ? 'checked' : '' }}>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check form-switch mt-3">
                                        <input class="form-check-input" type="checkbox" name="show_logo" value="1"
                                            id="show_logo" {{ $invoice_layout->show_logo ? 'checked' : '' }}>
