...
<div class="content container-fluid">
    ...
    <div class="leave-card">
        <div class="leave-card-header d-flex justify-content-between align-items-center">
            <h4><i class="fa fa-pencil"></i> {{ __('Edit Time Off Type') }}: {{ $leaveType->type_name }}</h4>
        </div>
        ...
        <form action="{{ route('leave.config.time-off-types.update', $leaveType->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="color" name="color" class="form-control form-control-color w-100" value="{{ old('color', $leaveType->color ?? '#0d6efd') }}">
                        </div>
                        <div class="col-md-3 mb-3">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12 mb-3">
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="uses_accrual" id="mode_fixed" value="0" {{ old('uses_accrual', $leaveType->uses_accrual) ? '' : 'checked' }} onchange="toggleAllocationMode()">
                                <label class="btn btn-outline-primary" for="mode_fixed">
                                    <i class="fa fa-hand-holding"></i> {{ __('Fixed Allocation (Manual)') }}
                                </label>

                                <input type="radio" class="btn-check" name="uses_accrual" id="mode_accrual" value="1" {{ old('uses_accrual', $leaveType->uses_accrual) ? 'checked' : '' }} onchange="toggleAllocationMode()">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="min_days_notice" class="form-control" value="{{ old('min_days_notice', $leaveType->min_days_notice) }}" min="0">
                        </div>
                        <div class="mb-3">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div class="mt-3">
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="requires_approval" id="requires_approval" value="1" {{ old('requires_approval', $leaveType->requires_approval) ? 'checked' : '' }} onchange="toggleApprovalFields()">
                        ...
                        <div id="approval_fields">
                            <div class="mb-3">
                                ...
                                <select name="approval_levels" class="form-select">
                                    ...
                                    <option value="3" {{ old('approval_levels', $leaveType->approval_levels) == '3' ? 'selected' : '' }}>{{ __('3 Levels (Manager + HR + Director)') }}</option>
                                </select>
                            </div>
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" name="auto_approve_if_balance" id="auto_approve_if_balance" value="1" {{ old('auto_approve_if_balance', $leaveType->auto_approve_if_balance) ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                ...
                <button type="submit" class="btn btn-primary px-4">{{ __('Update Time Off Type') }}</button>
            </div>
        </form>
    </div>
</div>
