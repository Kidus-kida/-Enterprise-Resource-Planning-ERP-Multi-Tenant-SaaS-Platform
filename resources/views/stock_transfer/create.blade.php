...
@section('page-content')
    ...
    <div class="content container-fluid">
        ...
        <x-breadcrumb class="col">
            <x-slot name="title">@lang('lang_v1.add_stock_transfer')</x-slot>
            <ul class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('dashboard') }}">@lang('messages.dashboard')</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="{{ route('stock-transfers.index') }}">@lang('lang_v1.stock_transfers')</a>
                </li>
        ...
        <form action="{{ action([\App\Http\Controllers\StockTransferController::class, 'store']) }}" method="POST"
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="transaction_date" class="form-control" value="{{ \Carbon\Carbon::now()->format('Y-m-d H:i:s') }}" readonly required>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="mb-3">
                                <label class="form-label">@lang('purchase.ref_no'):</label>
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                <label class="form-label">@lang('lang_v1.location_from'):*</label>
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                <label class="form-label">@lang('lang_v1.from_store'):*</label>
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                <label class="form-label">@lang('lang_v1.location_to'):*</label>
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                <label class="form-label">@lang('lang_v1.to_store'):*</label>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="card-title">@lang('stock_adjustment.search_products')</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search_product" id="search_product_for_srock_adjustment"
                                        class="form-control" placeholder="@lang('stock_adjustment.search_product')">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="stock_adjustment_product_table">
                            <thead>
                                <tr>
                                    <th class="col-sm-3 text-center">@lang('sale.product')</th>
                                    <th class="col-sm-2 text-center">@lang('sale.balance_qty')</th>
                                    <th class="col-sm-2 text-center">@lang('unit.units')</th>
                                    <th class="col-sm-1 text-center">@lang('sale.transfer_qty')</th>
                                    <th class="col-sm-2 text-center">@lang('sale.unit_price')</th>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="mb-3">
                                <label class="form-label">@lang('lang_v1.shipping_charges'):</label>
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                <label class="form-label">@lang('purchase.additional_notes'):</label>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="submit" id="save_stock_transfer"
                                class="btn btn-primary float-end">@lang('messages.save')</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            function loadStores(location_id) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#transfer_location_id').append('<option value="">{{__('messages.please_select')}}</option>');
                        $.each(result, function (i, location) {
                            $('#transfer_location_id').append(`<option value= "` + location.id + `">` + location.name + `</option>`);
                        });

                        //Reset To Store
                        $('#to_store').empty().append('<option value="">{{__('messages.please_select')}}</option>');
                    }
                });
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        $('#from_store').empty();
                        $('#from_store').append('<option value="">{{__('messages.please_select')}}</option>');
                        $.each(result, function (i, location) {
