                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('shifts.update', $shift->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="time" name="start_time" id="start_time" 
                                           ...
                                           value="{{ old('start_time', is_string($shift->start_time) ? date('H:i', strtotime($shift->start_time)) : $shift->start_time->format('H:i')) }}" required>
                                    @error('start_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="time" name="end_time" id="end_time" 
                                           ...
                                           value="{{ old('end_time', is_string($shift->end_time) ? date('H:i', strtotime($shift->end_time)) : $shift->end_time->format('H:i')) }}" required>
                                    @error('end_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="grace_period_minutes" class="form-label">{{ __('Clock-In Grace (minutes)') }}</label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    @php
                                        ...
                                        $workDays = json_decode($shift->work_days, true) ?? [];
                                    @endphp
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="work_days[]" 
                                                       ...
                                                       {{ in_array($value, old('work_days', $workDays)) ? 'checked' : '' }}>
                            ...
                            <div class="text-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="la la-save"></i> {{ __('Update Shift') }}
                                </button>
                            </div>
                        </form>
                    </div>
