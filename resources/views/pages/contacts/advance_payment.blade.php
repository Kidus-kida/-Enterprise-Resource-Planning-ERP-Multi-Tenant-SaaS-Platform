<div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {!! Form::open(['url' => action([\Modules\Contacts\Http\Controllers\ContactController::class, 'postAdvancePayment'], $contact_id), 'method' => 'post', 'id' => 'pay_contact_due_form', 'files' => true ]) !!}
